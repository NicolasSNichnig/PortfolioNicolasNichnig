...
const ListaSkills = () => {
    ...
    <div className="flex flex-col justify-center items-center w-full">
        ...
        {isOpen && (
        <div className="grid p-2 md:p-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 w-full rounded-md text-sm md:text-[20px] animate-fade-down animate-once animate-ease-out animate-fill-forwards">
            <div className="hover:scale-105 flex flex-col items-center text-center p-3 rounded-[12px] bg-[#0c1527]/40 hover:bg-[#0c1527]/60 transition-colors duration-300">
